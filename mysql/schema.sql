...
-- ============================================================
-- email_events — log of automated lifecycle emails sent to each
-- user (welcome, incomplete-profile nudge). The unique constraint is
-- what actually prevents a duplicate send — see src/lib/email.ts and
-- src/app/api/cron/nudge-incomplete-profiles/route.ts.
-- ============================================================
